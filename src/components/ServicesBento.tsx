...
// rest. Cards use the standard on-brand surface (white + hairline border) and
// reserve a media slot at the top for animated assets.
...
const services: Service[] = [
  ...
  },
  {
    ...
    desc: 'We automate the repetitive work by connecting your apps through API integrations, scheduling tasks and cron jobs, and optimizing the processes that quietly eat your time.',
  },
  {
  ...
  },
  {
    ...
    desc: 'Websites, web apps, internal dashboards, customer portals, and custom integrations, all built around the way your business actually works.',
  },
  {
        ...
        <div className="mt-14 grid grid-cols-1 gap-4 md:grid-cols-3">
          {services.map((s) => (
            ...
            >
              ...
              <div
                aria-hidden
                className={`mb-6 rounded-xl border border-line bg-[#f1f3f7] ${
                  s.big ? 'h-44' : 'h-28'
                }`}
              />
